        ...
        <div>
            <div className="grid lg:grid-cols-5 md:grid-cols-2 items-center gap-y-4 h-full">
                <div className="max-md:order-1 lg:col-span-3 md:h-screen w-full bg-[#000842] md:rounded-tr-xl md:rounded-br-xl lg:p-12 p-8">
                    <img src="https://readymadeui.com/signin-image.webp" className="lg:w-2/3 w-full h-full object-contain block mx-auto" alt="login-image" />
                </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    <input value={formData.email} onChange={handleChange} name="email" type="text" required className="w-full text-sm text-slate-900 bg-slate-100 focus:bg-transparent pl-4 pr-10 py-3.5 rounded-md border border-gray-200 focus:border-blue-600 outline-none" placeholder="Enter email" />
                            ...
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    <input value={formData.password} onChange={handleChange} name="password" type="password" required className="w-full text-sm text-slate-900 bg-slate-100 focus:bg-transparent pl-4 pr-10 py-3.5 rounded-md border border-gray-200 focus:border-blue-600 outline-none" placeholder="Enter password" />
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4">
                                <div className="flex items-center">
                                    <input checked={formData.rememberMe} onChange={handleChange} id="remember-me" name="rememberMe" type="checkbox" className="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-slate-300 rounded-md" />
